...
public class DonationActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        text_explin = rootView.findViewById(R.id.text_explain);
        ...
        if(isVenture){
            text_explin.setText("응원할 마일리지를 입력해주세요");
        }
    ...
    private void setData(Business business){
        ...
        if(isVenture){
            text_type.setText("벤처기업 응원  하기");
            btn_donation.setBackground(getResources().getDrawable(R.drawable.design_venture_button));
            btn_donation.setText("응원하기");
        }
        else {
            text_type.setText("에너지 기부하기");
            btn_donation.setBackground(getResources().getDrawable(R.drawable.design_main_button));
            btn_donation.setText("기부하기");
        }
    ...
    private void makeDialog(){
        ...
        isVenture = cur_business.isVenture();
